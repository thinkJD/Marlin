...
#define STRING_CONFIG_H_AUTHOR "(thinkJD, i3Berlin config)" // Who made the changes.
...
#define HOTEND_OFFSET_X {0.0, 39.57} // (in mm) for each extruder, offset of the hotend on the X axis
#define HOTEND_OFFSET_Y {0.0, 0.85}  // (in mm) for each extruder, offset of the hotend on the Y axis
...
#define TEMP_SENSOR_1 59
#define TEMP_SENSOR_2 0
#define TEMP_SENSOR_3 0
#define TEMP_SENSOR_4 0
#define TEMP_SENSOR_BED 1  // seems ok for the unknown printbed thermistor
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600 ,158 }
